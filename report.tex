...
\lstinputlisting[language=C, firstline=60, lastline=82]{task1.c}
...
\lstinputlisting[language=C, firstline=84, lastline=98]{task1.c}
...
\lstinputlisting[language=C, firstline=100, lastline=109]{task1.c}
...
\lstinputlisting[language=C, firstline=110, lastline=127]{task1.c}
